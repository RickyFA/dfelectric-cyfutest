...
#        self.EDcorrienteEntry=tk.Entry(self.EDFramePosiCur,textvariable=self.EDCorriente)
    ...
    def F_BorrarDatos(self):
        def Borrar():
            ...
            self.EDPotDis.config(state=tk.NORMAL)
            self.EDNoFusion.config(state=tk.NORMAL)
            self.EDFusion.config(state=tk.NORMAL)
            self.ED10x38.config(state=tk.NORMAL)
            self.ED14x51.config(state=tk.NORMAL)
            self.ED22x58.config(state=tk.NORMAL)
            self.ED1mm.config(state=tk.NORMAL)
            self.ED1_5mm.config(state=tk.NORMAL)
            self.ED2_5mm.config(state=tk.NORMAL)
            self.ED4mm.config(state=tk.NORMAL)
            self.ED6mm.config(state=tk.NORMAL)
            self.ED10mm.config(state=tk.NORMAL)
            self.ED16mm.config(state=tk.NORMAL)
            self.ED25mm.config(state=tk.NORMAL)
            self.ED35mm.config(state=tk.NORMAL)
            self.ED50mm.config(state=tk.NORMAL)
            self.ED1hora.config(state=tk.NORMAL)
            self.ED2horas.config(state=tk.NORMAL)
            self.ED1min.config(state=tk.NORMAL)
            self.EDcorrienteEntry.config(state=tk.NORMAL)
            self.EDStartButton.config(state=tk.NORMAL)
            self.EAStartButton.config(state=tk.DISABLED)
            self.EAEntryReferencia.config(state=tk.NORMAL)
            self.EDEntryTestReport.config(state=tk.DISABLED)
            self.EDButtonTestReport.config(state=tk.DISABLED)
            self.EAButtonCargar.config(state=tk.NORMAL)
            self.EAButtonBuscar.config(state=tk.NORMAL)
